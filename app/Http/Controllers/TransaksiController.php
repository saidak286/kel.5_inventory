...
class TransaksiController extends Controller
{
    ...
    public function apiTransaksiDetail($id)
    {
        ...
        if($transaksi) { //jika data transaksi ditemukan
            return response()->json(
                [
                    'success'=>true,
        ...
        else { //jika data transaksi tidak ditemukan
            return response()->json(
                [
                    'success'=>false,
    ...
    public function destroy($id)
    {
        ...
        if ($transaksi ['code'] != 0) {
            ...
            return redirect()->route('transaksi.index')
                ->with('alert', 'Data transaksi Tidak Dapat Dihapus');
        }
        else {
