...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item {{ 'administrator' == request()->path() ? 'active' : '' }}">
            <a href="{{url('/administrator')}}" class="menu-link">
        ...
        <!-- Tables -->
        <li class="menu-item {{ 'transaksi' == request()->path() ? 'active' : '' }}">
        ...
        <!-- Tables -->
        <li class="menu-item {{ 'barang' == request()->path() ? 'active' : '' }}">
        ...
        <!-- Tables -->
        <li class="menu-item {{ 'jenis' == request()->path() ? 'active' : '' }}">
            <a href="{{url('/jenis')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table"></i>
                <div data-i18n="Tables">Jenis Barang</div>
            </a>
        </li>
