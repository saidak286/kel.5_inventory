            ...
            <div class="w-full px-4">
                <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                    ...
                    <ul class="mb-10 flex flex-wrap items-center justify-center">
                        ...
                        <li>
                            <a href="{{ url('/administrator') }}" target="_blank" class="flex items-center py-4 px-6 text-base font-medium text-white transition duration-300 ease-in-out hover:opacity-70 sm:px-10">
                                Admin
                                <span class="pl-2">
