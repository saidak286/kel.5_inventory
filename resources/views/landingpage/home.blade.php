        ...
        <div class="-mx-4 flex flex-wrap items-center">
            <div class="w-full px-4">
                <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                    ...
                    <ul class="mb-10 flex flex-wrap items-center justify-center">
                        <li>
                            <a href="{{ url('/administrator') }}" class="inline-flex items-center justify-center rounded-lg bg-white py-4 px-6 text-center text-base font-medium text-dark transition duration-300 ease-in-out hover:text-primary hover:shadow-lg sm:px-10">
                                Page Admin
                            </a>
                        </li>
            ...
            <div class="w-full px-4">
                <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
                    <div class="mt-16">
                        <img src="{{ url('assets/images/hero/hero-image.jpeg') }}" alt="hero" class="mx-auto max-w-full rounded-t-xl rounded-tr-xl" />
                    </div>
